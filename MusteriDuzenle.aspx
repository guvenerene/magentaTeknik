<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MusteriDuzenle.aspx.cs" Inherits="musteriEkle" %>
...
<div style=" width:900px; margin-top:5%; margin-Left:100px;"><h1>Müşteri Bilgi 
    Güncelleme</h1></div>
    <table class="MusteriEkleTablo">
        <tr>
            <td class="MusteriEkleTD">T.C. Kimik No</td>
            <td >
                <asp:TextBox ID="txtTCNo" runat="server" Width="200px" Enabled="False"></asp:TextBox>
            </td>
            <td >
        ...
        <tr>
            ...
            <td class="MusteriEkleTabloKolonIki" >
                <asp:TextBox ID="txtAdSad" runat="server" Width="200px" Enabled="False"></asp:TextBox>
            </td>
            <td >
        ...
        <tr>
            <td colspan="3">
                <asp:Button ID="btnDuzenle" runat="server" Text="Müşteri Düzenle" 
                    OnClick="btnDuzenle_Click" CssClass="MusteriEkleButon" 
                    ValidationGroup="EkleValidations" />
            </td>
        </tr>
        <tr>
            <td colspan="3">
